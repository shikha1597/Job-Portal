...
sql1="delete from vacancy where course_id=%d and company_id=%d and dept_id=%d and post_name='%s' "%(c_id,c1_id,d_id,post_name)
try:	
	c.execute(sql1)
	db.commit()
...
print "<form>"
print "<input type='submit' value='Add More Vacancies' formaction='AddVacancy.py'>"
print "<input type='submit' value='Update/Delete Vacancy' formaction='UpdateVacancyDetail.py'>"
print"</br></br>"
try:
