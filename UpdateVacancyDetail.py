...
#######################################################################################################
print '<center><u><h2>Search Vacancy</u></h2></center>'
print "<form id='f101'>"

print"Company id         </br>"
print"<input type='text' name='C1' value='",L1,"' readonly required /></br>"
print "Course</br>"
...
print "Post Name</br>"
print"<input type='text' name='C2' required /></br>"

print "</br><center><input type='Submit' value='Search' formaction='searchVacancy.py'></center>"
