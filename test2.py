...
print '<li class="active"><a href="contact_2.html">Employer</a></li>'
print '<li class="active"><a href="jobSeeker.html">Job Seeker</a></li>'
print '</ul>'
print '</div>'
print '</div>'
print '</div>'
...
try:
	...
	c=db.cursor()
	sql="delete from student where s_id=%d"%(t1)
	try:
		c.execute(sql)
		db.commit()
