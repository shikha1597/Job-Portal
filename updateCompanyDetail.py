...
#######################################################################################################
print '<center><h2><u>Updating Personal Information</u></h2></center>'
try:
		db=MySQLdb.connect("127.0.0.1","root","","dbjobportal")
		c=db.cursor()
		sql="select * from company_basic where company_id=%d"%(t1)
		try:	
			...
			print "<td ><input type='text' value='Company Name' readonly /></td> "
			print "<td><input type='text' value='CEO' readonly /></td> "
			print "<td><input type='text' value='About' readonly /></td>"
			print "<td><input type='text' value='Email id' readonly /></td>"
			print "<td><input type='text' value='Phone Number' readonly /></td>"
			print "<td><input type='text' value='Address' readonly /></td>"
			...
			for row in resultset:
				...
				print "<form action='updateCompanyDetail1.py' method='post'>"
				print("<table>")
				print "<tr><td><input type='text' name='t11' value=%d"%(id)+" required  readonly/></td>"
				print "<td><input type='text' name='t12' value='"+name+"' required /></td>"
				print "<td><input type='text' name='t13' value='"+d+"' required /></td>"
				print "<td><input type='text' name='t14' value='"+about+"' required /></td>"
				print "<td><input type='email' name='t15' value='"+e+"' required /></td>"
				print "<td><input type='text' name='t16' value='"+c+"' required /></td>"
				print "<td><input type='text' name='t17' value='"+t1+"' required /></td>"
				print "<td><input type='text' name='t18' value='"+t2+"' required /></td></tr></table>"		
				print"<br/><br/>"
